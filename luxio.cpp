...
PHP_MINIT_FUNCTION(luxio)
{
    ...
    REGISTER_LONG_CONSTANT("LUX_DB_RDONLY", Lux::IO::DB_RDONLY, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("LUX_DB_RDWR", Lux::IO::DB_RDWR, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("LUX_DB_CREAT", Lux::IO::DB_CREAT, CONST_CS | CONST_PERSISTENT);
    REGISTER_LONG_CONSTANT("LUX_DB_TRUNC", Lux::IO::DB_TRUNC, CONST_CS | CONST_PERSISTENT);
